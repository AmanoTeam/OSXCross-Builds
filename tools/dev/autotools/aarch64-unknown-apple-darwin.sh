...
CMAKE_TOOLCHAIN_FILE='/tmp/darwin-clang-cross/build/cmake/aarch64-unknown-apple-darwin.cmake'

CC='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin20.4-clang'
CXX='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin20.4-clang++'
AR='/usr/bin/llvm-ar'
AS='/usr/bin/llvm-as'
LD='/tmp/darwin-clang-cross/bin/aarch64-apple-darwin20.4-ld'
NM='/usr/bin/llvm-nm'
