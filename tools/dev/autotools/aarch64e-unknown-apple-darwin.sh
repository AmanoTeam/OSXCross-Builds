...
CC='/tmp/darwin-clang-cross/bin/arm64e-apple-darwin20.4-clang'
CXX='/tmp/darwin-clang-cross/bin/arm64e-apple-darwin20.4-clang++'
AR='/usr/bin/llvm-ar'
AS='/usr/bin/llvm-as'
LD='/tmp/darwin-clang-cross/bin/arm64e-apple-darwin20.4-ld'
NM='/usr/bin/llvm-nm'
